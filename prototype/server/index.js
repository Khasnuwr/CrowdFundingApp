...
async function run() {
    try {
        ...
        const classesCollection = client.db('DonationDB').collection('classes');
        const paymentsCollection = client.db('DonationDB').collection('payments');
        const classesCartCollection = client.db('DonationDB').collection('classesCart');
        const popularTeachersCartCollection = client.db('DonationDB').collection('popularTeachers');
